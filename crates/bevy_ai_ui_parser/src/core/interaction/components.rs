...
/// Pre-order focus sequence captured while spawning the BUI document tree.
#[derive(Component, Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord)]
pub(crate) struct BuiFocusOrder(pub(crate) u32);
...
#[derive(Component, Debug, Clone)]
pub(crate) struct BuiScrollView {
    pub(crate) binding_source: Option<String>,
}

#[derive(Component, Debug, Clone)]
pub(crate) struct BuiDropdownGroupDefinition {
    pub(crate) group: String,
    pub(crate) source: String,
}

#[derive(Component, Debug, Clone)]
pub(crate) struct BuiDropdownItem {
    pub(crate) group: String,
    pub(crate) value: String,
}
...
pub(crate) struct BuiVisualStateDefinitions {
    pub(crate) states: BTreeMap<String, BuiStateVisual>,
}

/// Base visual style captured before runtime state overlays are applied.
#[derive(Component, Debug, Clone)]
pub(crate) struct BuiBaseVisualState(pub(crate) BuiStateVisual);
