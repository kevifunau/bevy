...
const BEVY_UI_COMPILE_VIEWPORT_WIDTH: f32 = 1920.0;
const BEVY_UI_COMPILE_VIEWPORT_HEIGHT: f32 = 1080.0;
...
impl OpenDesignViewport {
    ...
    pub(crate) const fn bevy_ui_compile() -> Self {
        Self {
            width: BEVY_UI_COMPILE_VIEWPORT_WIDTH,
            height: BEVY_UI_COMPILE_VIEWPORT_HEIGHT,
        }
    }
}
