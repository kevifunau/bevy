...
pub(crate) fn apply_opendesign_declaration(bui_node: &mut BuiNode, name: &str, value: &str) {
    ...
    match name {
        ...
        "padding-inline" => {
            set_simple_css_val(&mut bui_node.layout.styles.padding_left, &value);
            set_simple_css_val(&mut bui_node.layout.styles.padding_right, &value);
        }
        "padding-block" => {
            set_simple_css_val(&mut bui_node.layout.styles.padding_top, &value);
            set_simple_css_val(&mut bui_node.layout.styles.padding_bottom, &value);
        }
        "gap" => {
            if let Some(size) = css_first_size(&value) {
                bui_node.layout.styles.row_gap = Some(size.clone());
                bui_node.layout.styles.column_gap = Some(size);
            }
        }
        ...
        "place-items" => {
            if value == "center" {
                bui_node.layout.styles.align_items = Some("center".to_string());
                bui_node.layout.styles.justify_items = Some("center".to_string());
        ...
        "overflow-x" => {
            if value == "auto" || value == "scroll" {
                bui_node.layout.styles.overflow = Some("scroll_x".to_string());
            }
        }
        "overflow-y" => {
            if value == "auto" || value == "scroll" {
                bui_node.layout.styles.overflow = Some("scroll_y".to_string());
            }
        }
