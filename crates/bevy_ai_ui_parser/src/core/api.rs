...
use crate::core::{
    ...
    parse::validate::{
        validate_bui_ir_json_file as parse_validate_bui_ir_json_file,
        validate_bui_ir_json_str as parse_validate_bui_ir_json_str,
...
pub fn validate_bui_ir_json_str(json: &str) -> Result<(), String> {
    parse_validate_bui_ir_json_str(json)
}
...
pub fn validate_bui_ir_json_file(path: impl AsRef<Path>) -> Result<(), String> {
    parse_validate_bui_ir_json_file(path)
}
